...
import com.demo.date.presentation.ArgumentParser;
import com.demo.date.presentation.DateDifferenceFormatter;
import com.demo.date.presentation.DateDifferenceApplication;
...
public class DateDifferenceApplicationEndToEndTest {
    ...
    private DateDifferenceApplication twoDates() {
        return twoDates(output);
    }

    private DateDifferenceApplication twoDates(PrintStream printStream) {
        return new DateDifferenceApplication(printStream, new ArgumentParser(), new DateParser(new DateFactory()), FORMATTER);
    }
